...
export const getSellerViewResolvers = {
  Query: {
  ...
  SellerView: {
    drones: async (parent) =>
      await Drone.find({ sellerId: parent.customId }),
    parts: async (parent) =>
    ...
    services: async (parent) =>
     ...
     hirepilots: async (parent) =>
      await HirePilot.find({ sellerId: parent.customId }),

    hirejobs: async (parent) =>
      await HireJob.find({ sellerId: parent.customId }),
  },
};