...
export const hirePilotTypeDefs = gql`
  ...
  extend type Query {
    ...
    hirePilotsApproved(sellerId: String!): [HirePilot]
    hirePilotsPending(sellerId: String!): [HirePilot]
    hirePilotsRejected(sellerId: String!): [HirePilot]
  ...
  extend type Mutation {
    ...
    updateHirePilot(pilotId: String!, input: UpdateHirePilotInput!): HirePilot!
